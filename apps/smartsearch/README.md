<div align="center">
  <img src="https://raw.githubusercontent.com/hamza5/smartsearch/main/docs/images/logo.svg" alt="SmartSearch Logo" width="120" />
  <h1>SmartSearch</h1>
  <p><strong>Your Intelligent Local File Finder</strong></p>

[![CI](https://github.com/hamza5/smartsearch/actions/workflows/ci.yml/badge.svg)](https://github.com/hamza5/smartsearch/actions/workflows/ci.yml)
[![Release](https://github.com/hamza5/smartsearch/actions/workflows/release.yml/badge.svg)](https://github.com/hamza5/smartsearch/actions/workflows/release.yml)
[![PyPI version](https://badge.fury.io/py/smartsearch.svg)](https://badge.fury.io/py/smartsearch)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/smartsearch.svg)](https://pypi.org/project/smartsearch/)
[![License: GPL v3](https://img.shields.io/badge/License-GPLv3-blue.svg)](https://github.com/hamza5/smartsearch/blob/main/LICENSE)

</div>

<p align="center">
  Find what you mean, not just what you say. SmartSearch runs locally on your machine to index and understand your files.
</p>

![SmartSearch Demo](https://raw.githubusercontent.com/hamza5/smartsearch/main/docs/images/SmartSearch_demo_annotated.GIF)

## What is SmartSearch?

SmartSearch is a desktop application that helps you find files instantly using natural language. Instead of remembering exact filenames, you can ask questions like "flight ticket invoice", and SmartSearch uses semantic search to understand the meaning and show the relevant files.
...
- **🛡️ Read-Only & Safe**: SmartSearch only reads your files to index them. It never modifies, deletes, or alters your data in any way.
- **🔒 Privacy First**: All indexing and processing happens 100% locally on your machine. Your data never leaves your computer.

## Why SmartSearch?

Most search tools look for _exact matches_ of filenames or content. SmartSearch goes further by understanding _meaning_, tolerating typos, and extracting text from images. See how it compares to other popular tools:
...
| **SmartSearch** | **Free** | **Cross-platform** | **Yes**  | **Very fast** | **1000+ formats**   | **Yes**          | **Yes**         | **Yes** |
...
Install SmartSearch easily using pip:

```bash
pip install -U smartsearch
```
...
2.  **Initialization Wizard**:
    ...
    ![Initialization Wizard](https://raw.githubusercontent.com/hamza5/smartsearch/main/docs/images/wizard.png)
...
> [!NOTE]
> SmartSearch must be running for the background indexing to process your files.
...
![Dashboard Overview](https://raw.githubusercontent.com/hamza5/smartsearch/main/docs/images/dashboard.png)

### Semantic Search

Search naturally, like "Airplane ticket" to find relevant documents even if the filename is different.

![Semantic Search](https://raw.githubusercontent.com/hamza5/smartsearch/main/docs/images/search.png)
...
[Check out the website](https://smartsearch.com/) to learn more.
...
SmartSearch expects the embedding model to be in a specific system directory. Create it manually:

**Linux / macOS:**

```bash
mkdir -p ~/.local/share/smartsearch/typesense-data/models/ts_paraphrase-multilingual-mpnet-base-v2
```

**Windows (PowerShell):**

```powershell
New-Item -Path "$env:LOCALAPPDATA\smartsearch\typesense-data\models\ts_paraphrase-multilingual-mpnet-base-v2" -ItemType Directory -Force
```
...
_Note: Once the images are pulled and the model files are in place, SmartSearch will handle starting the services automatically on the next run._
