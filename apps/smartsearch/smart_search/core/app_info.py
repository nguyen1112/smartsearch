...
def get_app_info():
    ...
    try:
        ...
        # From smart_search/core/app_info.py, go up two levels to reach pyproject.toml
        ...
        if os.path.exists(pyproject_path):
            ...
            return {
                "name": project_data.get("name", "smartsearch"),
                "version": project_data.get("version", "0.0.0"),
                "description": project_data.get("description", "SmartSearch"),
            }
        ...
        try:
            pkg_version = version("smartsearch")
            return {
                "name": "smartsearch",
                "version": pkg_version,
        ...
        return {"name": "smartsearch", "version": "0.0.0-error", "description": "SmartSearch"}
