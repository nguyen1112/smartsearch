...
from smart_search.database.models.crawler_state import CrawlerState as DBCrawlerState
from smart_search.database.repositories.base import BaseRepository
